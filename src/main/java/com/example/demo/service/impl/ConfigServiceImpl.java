...
import com.example.demo.dao.BlogConfigMapper;
...
public class ConfigServiceImpl implements ConfigService {
    ...
    public static final String websiteName = "J12 Blog";
    public static final String websiteDescription = "J12的个人博客";
    public static final String websiteLogo = "/admin/dist/img/j.jpg";
    public static final String websiteIcon = "/admin/dist/img/j.jpg";

    public static final String yourAvatar = "/admin/dist/img/billie.jpg";
    public static final String yourEmail = "1428434791@qq.com";
    public static final String yourName = "J12";

    public static final String footerAbout = "drop the beats";
    public static final String footerICP = "xxxxxx-x号";
    public static final String footerCopyRight = "J12";
    public static final String footerPoweredBy = "J12 blog";
